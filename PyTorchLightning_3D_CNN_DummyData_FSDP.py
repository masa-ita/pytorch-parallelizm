...
class ThreeDCNN(pl.LightningModule):
    ...
    def configure_sharded_model(self):
        layers = auto_wrap(checkpoint_wrapper(self.layers))
...
# strategy = pl.strategies.DDPFullyShardedStrategy(cpu_offload=True)
...
trainer = pl.Trainer(devices=[0,1,2,3], accelerator="gpu", precision=16, max_epochs=NUM_EPOCHES, strategy="FSDP")
